export const site = {
  name: 'Vidya Geomatics Solution',
  legalName: 'Vidyageomatics Solution Pvt. Ltd.',
  shortName: 'Vidyageomatics',
  brand: 'VIDYA GEOMATICS SOLUTION',
  metaDescription: 'Mapping the Future, Building the Present.',
  tagline: 'Excellence in Every Detail, Strength in Every Build',
  trustedLine: 'The trusted name for Survey Engineering Solutions',
  rentalLine: 'Rental of top technology at best prices',
  established: '2019',
  experienceYears: '6+',
  country: 'INDIA',
  email: 'info@vidyageomatics.com',
  phones: [
    { display: '+91 94254 12562', tel: '+919425412562', raw: '9425412562' },
    { display: '+91 99583 58349', tel: '+919958358349', raw: '9958358349' },
  ],
  whatsapp: 'https://wa.me/919425412562',
  whatsappNumber: '919425412562',
  whatsappMessage:
    'Hello, I would like to inquire about Vidya Geomatics survey and mapping services.',
  hours: {
    days: 'Monday - Friday',
    time: '9:00 - 17:00',
  },
  address: {
    line1: 'Aastha height Lambhakheda',
    pin: '462038',
...
export const aboutLong = [
  'VIDYA GEOMATICS SOLUTION is the most leading Organization in the field of Land Survey, Mobile Mapping solutions, Drone mapping and laser scanning solutions.',
  'VIDYA GEOMATICS SOLUTION is a pioneering Survey Engineering Company in INDIA established in the year of 2019. VIDYA GEOMATICS SOLUTION Survey Engineering built on a strong work ethic, honesty and a commitment to relationships.',
...
export const vision =
  'VIDYA GEOMATICS SOLUTION aims to establish itself as a leader in the local construction industry. With a strong commitment to our client and our craft, we are dedicated to delivering the quality work you deserve while helping you reduce costs.'
...
export const joinText =
  'Join us as we continue to shape the skyline and landscapes of tomorrow, delivering projects that stand as a testament to our commitment to quality, innovation, and customer satisfaction.'

export const sustainabilityText =
  'In every aspect of our operations, we take proactive measures to minimize waste, implement environmentally friendly practices, and ensure the highest standards of health and safety.'
...
export const whyChoosePoints = [
  'International Standard and Quality in Land Surveying, Underground Surveying, 3D Laser Scanning, GIS and Geographic Surveys.',
  'More than 6 years of conscientious and reliable engineering survey solutions for infrastructure, construction and development projects.',
  'Trusted by Clients, Government Sectors, Consultants & Construction Companies in India.',
  'Survey engineering built on a strong work ethic, honesty and a commitment to relationships.',
]

export const teamPhotos = [
  { src: '/team/01.jpg', alt: 'Track survey team on railway site' },
  { src: '/team/02.jpg', alt: 'Vidya Geomatics field team' },
  { src: '/team/03.jpg', alt: 'Survey crew at project site' },
  { src: '/team/04.jpg', alt: 'On-site survey operations' },
  { src: '/team/05.jpg', alt: 'Team during field surveying' },
  { src: '/team/06.jpg', alt: 'Site blessing with survey crew' },
  { src: '/team/07.jpg', alt: 'Field marking and survey work' },
  { src: '/team/08.jpg', alt: 'Team at project commencement' },
  { src: '/team/09.jpg', alt: 'Vidya Geomatics professionals on site' },
  { src: '/team/10.jpg', alt: 'Survey team collaboration' },
  { src: '/team/11.jpg', alt: 'Field team at work' },
]

export const teamUnits = [
  {
    title: 'Land Surveying & Mapping',
    text: 'VGS employs a dedicated team of professionals for land surveying and mapping, using advanced GIS and CAD software such as AutoCAD and CIVIL 3D.',
  },
  {
    title: '3D Laser Scanning',
    text: 'Full-time professional staff utilizing cutting-edge 3D laser scanning to capture precise 3D models of geographic features.',
  },
  {
    title: 'As-Built Survey',
    text: 'Full-time professional staff skilled in 3D laser scanning and As-Built Total Station technology for 2D and 3D project monitoring.',
  },
  {
    title: 'Aerial / Drone Mapping',
    text: 'Specialist crews operating DJI RTK drones for centimetre-accurate photogrammetry, construction updates and land surveys.',
  },
  {
    title: 'Tunnel Survey',
    text: 'Full-time professional staff for tunnel surveying, using NRG, TBC and Amberg tunneling software.',
  },
  {
    title: 'Track Surveying',
    text: 'Full-time professional staff for track surveying with total station, Digital Level and Track Master, using NRG, TBC and Amberg Leica software.',
  },
]
...
export const rental = {
  ...
  intro:
    'Vidya Geomatics Solution (VGS) offers technical consultancy and manpower services, including the rental of skilled survey teams. Their services include:',
  items: [
    'Supplying surveyors on a daily, weekly, monthly, or yearly basis.',
    'Providing survey teams (surveyor with assistant) on a daily, weekly, monthly, or yearly basis.',
    'Supplying survey engineers.',
    'Providing draughtsmen.',
  ],
  note: 'VGS ensures clients have access to qualified professionals and teams tailored to their specific project needs, whether short-term or long-term.',
  equipmentLine: 'Rental of top technology at best prices',
}
...
export const clientsSub = 'Our Recent Clients'
